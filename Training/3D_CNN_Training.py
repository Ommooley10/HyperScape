...
with open("/content/drive/MyDrive/land-cover-classification-master/train_data_3d.pkl", "rb") as f:
    X_train, y_train = pickle.load(f)

with open("/content/drive/MyDrive/land-cover-classification-master/val_data_3d.pkl", "rb") as f:
...
# Build model
input_shape = X_train.shape[1:]  # (PATCH_SIZE, PATCH_SIZE, NUM_COMPONENTS, 1)

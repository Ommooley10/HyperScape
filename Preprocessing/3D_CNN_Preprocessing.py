...
X = np.array(X)[..., np.newaxis]  # (N, P, P, C, 1)
...
# Save datasets
with open("/content/drive/MyDrive/land-cover-classification-master/train_data_3d.pkl", "wb") as f:
    pickle.dump((X_train, y_train), f)

with open("/content/drive/MyDrive/land-cover-classification-master/val_data_3d.pkl", "wb") as f:
...
print(f"Saved shapes - Train: {X_train.shape}, Val: {X_val.shape}, Test: {X_test.shape}")
